...
<tr>
        <?php
$idd = $_SESSION['id'];
$consulta = "SELECT T2.id, T1.nombre,T2.estado,T2.fecha
FROM usuarios T1 INNER JOIN trabajos T2 where T1.id = T2.id_contrata and T2.id_Contratado = $idd";
$ejecutar = mysqli_query($con, $consulta);
$i = 0;
...
?>
  ...
  <?php 
if($estado != "Terminado"){?>
<td><a href="trabajos.php?edit=<?php echo $id;?>">Terminado</a></td>
<?php
}
  ?>
